...
const LINK_COLUMNS = [
  { heading: 'Company', links: ['Founding', 'Platform', 'Testify'] },
  { heading: 'Mobile', links: ['Get Apple App', 'Get Google App'] },
  { heading: 'Contracts', links: ['Private Data', 'User Consent'] },
]
                  ...
                  <div key={column.heading}>
                    ...
                    <ul className="space-y-2">
                      {column.links.map((label) => (
                        <li key={label}>
                          <a href="#" className="font-medium text-gray-500 transition hover:text-orange-600">
                            {label}
                          </a>
                        </li>
                      ))}
